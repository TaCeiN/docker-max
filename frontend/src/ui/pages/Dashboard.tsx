  ...
  return (
    <main className="screen">
        ...
        <div className="card__text">
          ...
          <div className="subtitle">
            {favoriteNote && todoProgress && todoProgress.total > 0 ? (
              <>
                {todoProgress.completed} из {todoProgress.total}, так держать!
              </>
            ) : (
      ...
      <div className="row two-columns">
        {/* Date Card */}
        <div className="card card--date" aria-label="Дата">
      ...
      <div ref={scenarioPillRef} className="pill--scenario">Сценарий использования не выбран</div>
    </main>
  )
}
